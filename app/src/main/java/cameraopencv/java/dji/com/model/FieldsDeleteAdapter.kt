...
class FieldsDeleteAdapter(private val listener: RecyclerViewClickListener) :
        RecyclerView.Adapter<FieldsDeleteAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View, private val listener: RecyclerViewClickListener) :
        ...
        private val buttonView: View = itemView.findViewById(R.id.deletefield_delete)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val contactView = inflater.inflate(R.layout.item_field_delete, parent, false)
